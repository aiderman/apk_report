<div class="bottom-navigation bottom-navigation--gradient">
	<ul class="bottom-navigation__icons">
		<li><a href="<?php echo base_url('C_login/') ?>"><img src="<?php echo base_url('assets') ?>/images/icons/black/logout.svg" alt="" title="" /></a></li>
		<li class="centered"><a href="<?php echo base_url('C_news/add_news') ?>"><img src="<?php echo base_url('assets') ?>/images/icons/white/plus-bold.svg" alt="" title="" /></a></li>
