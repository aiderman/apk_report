			...
			<form id="wrapped" method="POST">
				...
				<div id="middle-wizard">
					...
					<div class="step">
						...
						<div class="form-group">
							<input type="text" name="first_name" class="form-control required" placeholder="Judul" onchange="getVals(this, 'first_name');">
						</div>
						<div class="form-group">
							<input type="text" name="last_name" class="form-control required" placeholder="Keterangan" onchange="getVals(this, 'last_name');">
						</div>
						<!-- <div class="form-group terms">
							<label class="container_check">Please accept our <a href="#" data-toggle="modal" data-target="#terms-txt">Terms and conditions</a>
								<input type="checkbox" name="terms" value="Yes" class="required">
					...
					<div class="submit step">
						<h3 class="main_question"><strong>4/3</strong>Summary</h3>
						<div class="summary">
							<ul>
								<li><strong>1</strong>
									...
									<ul>
										...
										<li><label>Judul</label>: <span id="first_name"></span></li>
										<li><label>isi</label>: <span id="last_name"></span></li>
